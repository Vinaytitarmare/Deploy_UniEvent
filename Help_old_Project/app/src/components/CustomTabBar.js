            ...
            >
                <View style={styles.content}>
                    {state.routes.map((route, index) => {
                        ...
                        else if (route.name === 'AdminTab') iconName = isFocused ? 'settings' : 'settings-outline';
                        else if (route.name === 'RemindersTab') iconName = isFocused ? 'alarm' : 'alarm-outline';
                        else if (route.name === 'MyEventsTab') iconName = isFocused ? 'calendar' : 'calendar-outline';
