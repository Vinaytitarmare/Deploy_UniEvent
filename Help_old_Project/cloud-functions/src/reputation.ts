 ...
 */
export const calculateReputation = functions.https.onCall(async (data: any, context: functions.https.CallableContext) => {
  ...
  for (const clubDoc of clubsSnapshot.docs) {
    ...
    eventsSnapshot.forEach((eventDoc: admin.firestore.QueryDocumentSnapshot) => {
